...
# Ver el nuevo primer elemento de la cola
nuevo_primer_elemento = mi_cola.peek()
print("Elemento en la parte frontal de la cola después de dequeue (peek):", nuevo_primer_elemento)  # Salida: Elemento 2