...
# Eliminar otro elemento de la cola
otro_elemento_eliminado = mi_cola.dequeue()
print("Otro elemento eliminado:", otro_elemento_eliminado)  # Salida: Elemento 2
print("Estado de la cola después de hacer otro dequeue:", mi_cola.mostrar())  # Salida: ['Elemento 3']